...
export default function SidebarDemo() {
  const links = [
    ...
    { label: "CodeChef", href: "#", icon: <IconBrandTabler className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" /> },
    { label: "HackerRank", href: "#", icon: <IconBrandTabler className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" /> },
    {
      label: "Settings",
      href: "#",
              ...
              <div className="mt-1 flex flex-col gap-2">
                {links.map((link, idx) => (
                  <SidebarLink
                    ...
                    className={cn(
                      "flex items-center p-3 rounded-s-full transition-colors w-full", // Ensure consistent padding, width, and height
                      selectedLink === idx
